...
- 产出差距报告 `docs/0-tech/data-access-guidelines/report/{YYYYMMDD}-data-access-guidelines.md`，按 references/gap-report-template.md 填充：结论概览表 + 逐存储一节（合规项 / 差距项 / 规范未覆盖 / 规范条目无实现，各项均附证据文件路径）。
