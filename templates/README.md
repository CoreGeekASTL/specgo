...
> 注意：`Story设计README文档模板.md` 与 `功能域README文档模板.md` 产出同一文件 `docs/story/README.md`（同标题"功能软件要素文档"）——这是设计如此：spec-feature-analyze 建存量功能文档索引，spec-story-design 在其上增量维护新功能设计；两 skill 先后运行时后者在前者基础上更新，不是冲突。
